...
API_BASE_URL = os.getenv("API_BASE_URL", "https://test.sahilraz9265.workers.dev/num-lookup?num=")
# ⭐ दूसरा API यहाँ जोड़ा गया है ⭐
SECONDARY_API_URL = "https://test.sahilraz9265.workers.dev/num-lookup?num="
try:
